...
(
    nombre_espectaculo VARCHAR(100) PRIMARY KEY,
    descripcion_espectaculo VARCHAR(100),
...
(
    ...
    precio_grada INT,
    FOREIGN KEY(nombre_recinto_grada) REFERENCES Recinto(nombre_recinto) ON DELETE CASCADE, /*ESTO HACE Q SIEMPRE Q ELIMINEMOS UNA GRADA DE RECINTO TMB LA BORRE DE LA TABLA GRADAS*/
...
(
    ...
    FOREIGN KEY(nombre_recinto_localidad) REFERENCES Recinto(nombre_recinto) ON DELETE CASCADE, /*LO MISMO PARA ESTAS DOS*/
    FOREIGN KEY(nombre_grada_localidad) REFERENCES Grada(nombre_grada) ON DELETE CASCADE,
...
DROP PROCEDURE IF EXISTS eliminar_recinto;
...
CREATE PROCEDURE crear_espectaculo(
    IN nombre_espectaculo_in VARCHAR(100),
    IN descripcion_espectaculo_in VARCHAR(100),
...
CREATE PROCEDURE eliminar_recinto(IN nombre_recinto_eliminar VARCHAR(100))
BEGIN
...
CREATE PROCEDURE crear_usLoc(
    IN localizacion_localidad_in VARCHAR(100),
    IN nombre_grada_in VARCHAR(100),
    IN nombre_recinto_in VARCHAR(100),
